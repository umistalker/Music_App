class ImageUploadHelper:
    FIELDS_TO_COMBINE_MAP = {
        'defaults': {
            'upload_postfix': 'uploads'
        },
        'Musician': {
            'field': 'slug',
            'upload_postfix': 'musicians_images'
        },
        'Artist': {
            'field': 'slug',
    ...
    def get_field_to_combine_and_upload_postfix(cls, klass):
        field_to_combine = cls.FIELDS_TO_COMBINE_MAP[klass]['field']
        upload_postfix = cls.FIELDS_TO_COMBINE_MAP.get(
            'upload_postfix', cls.FIELDS_TO_COMBINE_MAP['defaults']['upload_postfix']
        )
